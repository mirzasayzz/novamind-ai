...
import type {NovaHubPal} from '../../src/types/novahub';
...
// NovaHub pal (free, public)
export const mockNovaHubPal: NovaHubPal = {
  type: 'novahub',
  id: 'novahub-pal-1',
  ...
  price_cents: 0,
  system_prompt: 'You are a helpful assistant from NovaHub.',
...
// NovaHub pal (premium, not owned)
export const mockPremiumNovaHubPal: NovaHubPal = {
  ...mockNovaHubPal,
  id: 'novahub-pal-2',
  title: 'Premium NovaHub Pal',
  protection_level: 'reveal_on_purchase',
  price_cents: 999,
  is_owned: false,
};

// NovaHub pal (premium, owned)
export const mockOwnedPremiumPal: NovaHubPal = {
...
// NovaHub pal (private)
export const mockPrivateNovaHubPal: NovaHubPal = {
  ...mockNovaHubPal,
  id: 'novahub-pal-4',
  title: 'Private NovaHub Pal',
...
// Factory function for creating custom NovaHub pals
export const createNovaHubPal = (
...
export const novaHubPalsList: NovaHubPal[] = [
  mockNovaHubPal,
  mockPremiumNovaHubPal,
  mockOwnedPremiumPal,
