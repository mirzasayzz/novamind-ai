...
/*const mockEnv = {
  ...
  APP_URL: 'novamind://app',
  ENABLE_NOVAHUB_INTEGRATION: 'true',
...
export const APP_URL = 'novamind://app';
export const AGENTROUTER_BASE_URL = '';
export const AGENTROUTER_API_KEY = '';
export const ENABLE_NOVAHUB_INTEGRATION = 'true';
...
export const NOVAHUB_API_BASE_URL = 'https://novahub.ai';
