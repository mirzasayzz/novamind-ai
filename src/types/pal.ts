 ...
 *
 * This represents a pal that has been created locally or downloaded from NovaHub
 ...
 *
 * Use the type discriminator `type: 'local'` to distinguish from NovaHubPal.
...
export interface Pal {
  ...
  // SOURCE TRACKING
  // ============================================================================
  /** Origin of this pal: 'local' (created on device) or 'novahub' (downloaded) */
  source: 'local' | 'novahub';
  /** If downloaded from NovaHub, the original NovaHub pal ID */
  novahub_id?: string;

  // ============================================================================
  // NOVAHUB METADATA (for downloaded pals only)
  // ============================================================================
  /** Creator information from NovaHub */
  creator_info?: {
    id: string;
    name?: string;
    avatar_url?: string;
  };
  /** Category names from NovaHub */
  categories?: string[];
  /** Tag names from NovaHub */
  tags?: string[];
  /** Average rating from NovaHub */
  rating?: number;
  /** Number of reviews from NovaHub */
  review_count?: number;
  /** Protection level from NovaHub */
  protection_level?: 'public' | 'reveal_on_purchase' | 'private';
  /** Price in cents from NovaHub (0 for free) */
  price_cents?: number;
  /** Whether the user owns this pal on NovaHub */
  is_owned?: boolean;

  /**
   * Raw NovaHub generation settings (from remote API)
   * Different format than local completion settings
   * Preserved for potential re-sync with NovaHub
   */
  rawNovahubGenerationSettings?: Record<string, unknown>;
