...
import {NovaHubErrorHandler, RetryHandler} from '../ErrorHandler';
import {NovaHubError} from '../NovaHubService';

describe('NovaHubErrorHandler', () => {
  describe('handle', () => {
    it('should handle NovaHubError', () => {
      const error = new NovaHubError('Test error', {code: 'TEST'});

      const result = NovaHubErrorHandler.handle(error);
  ...
  describe('shouldTriggerOfflineMode', () => {
    it('should trigger offline mode for network errors', () => {
      ...
      expect(NovaHubErrorHandler.shouldTriggerOfflineMode(errorInfo)).toBe(
        true,
      );
    });
  ...
  describe('getRetryDelay', () => {
    it('should return 0 for non-retryable errors', () => {
      ...
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 1)).toBe(0);
    });
    ...
    it('should use retryAfter value if provided', () => {
      ...
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 1)).toBe(10000); // 10000ms
    });
    ...
    it('should use exponential backoff for network errors', () => {
      ...
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 1)).toBe(1000);
      // Attempt 2: 1000 * 2^1 = 2000ms
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 2)).toBe(2000);
      // Attempt 3: 1000 * 2^2 = 4000ms
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 3)).toBe(4000);
      // Attempt 4: 1000 * 2^3 = 8000ms
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 4)).toBe(8000);
    });
    ...
    it('should use higher base delay for rate limit errors', () => {
      ...
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 1)).toBe(5000);
      // Attempt 2: 5000 * 2^1 = 10000ms
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 2)).toBe(10000);
      // Attempt 3: 5000 * 2^2 = 20000ms
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 3)).toBe(20000);
    });
    ...
    it('should cap retry delay at 30 seconds', () => {
      ...
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 10)).toBe(30000);
    });
    ...
    it('should cap rate limit retry delay at 30 seconds', () => {
      ...
      expect(NovaHubErrorHandler.getRetryDelay(errorInfo, 5)).toBe(30000);
    });
  });
  ...
  describe('formatForUser', () => {
    it('should return userMessage for standard errors', () => {
      ...
      expect(NovaHubErrorHandler.formatForUser(errorInfo)).toBe(
  ...
  describe('requiresAuthentication', () => {
    it('should return true for 401 auth errors', () => {
      ...
      expect(NovaHubErrorHandler.requiresAuthentication(errorInfo)).toBe(true);
    });
    ...
    it('should return false for 403 auth errors', () => {
      ...
      expect(NovaHubErrorHandler.requiresAuthentication(errorInfo)).toBe(false);
    });
  ...
  describe('insufficientPermissions', () => {
    it('should return true for 403 auth errors', () => {
      ...
      expect(NovaHubErrorHandler.insufficientPermissions(errorInfo)).toBe(true);
    });
    ...
    it('should return false for 401 auth errors', () => {
      ...
      expect(NovaHubErrorHandler.insufficientPermissions(errorInfo)).toBe(
        false,
      );
    });
...
describe('RetryHandler', () => {
  ...
  describe('withRetry', () => {
    ...
    it('should respect exponential backoff delays', async () => {
      ...
      expect(NovaHubErrorHandler.getRetryDelay(networkError, 1)).toBe(1000);
      expect(NovaHubErrorHandler.getRetryDelay(networkError, 2)).toBe(2000);
      expect(NovaHubErrorHandler.getRetryDelay(networkError, 3)).toBe(4000);
      expect(NovaHubErrorHandler.getRetryDelay(networkError, 4)).toBe(8000);
    });
    ...
    it('should use higher base delay for rate limit errors', async () => {
      ...
      expect(NovaHubErrorHandler.getRetryDelay(rateLimitError, 1)).toBe(5000);
      expect(NovaHubErrorHandler.getRetryDelay(rateLimitError, 2)).toBe(10000);
      expect(NovaHubErrorHandler.getRetryDelay(rateLimitError, 3)).toBe(20000);
    });
