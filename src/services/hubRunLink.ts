/**
 * Parser for the `novamind://hub/run` deep link.
 *
...
/**
 * True only for the exact `novamind://hub/run` route (host=hub, path=run),
...
/**
 * Parses and validates a `novamind://hub/run?repo_id=…&filename=…&source=…`
