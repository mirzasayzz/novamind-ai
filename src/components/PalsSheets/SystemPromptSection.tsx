...
import {generateFinalSystemPrompt} from '../../utils/novahub-template-parser';
  ...
  ({
    ...
    const buildGenerationPrompt = () => {
      ...
      if (isRoleplayPal) {
        ...
        // Generic fallback for other pal types (e.g., NovaHub pals)
        return [
    ...
    const handleGeneratePrompt = async () => {
      ...
      try {
        ...
        // Only set originalSystemPrompt if it's not already set (preserve NovaHub templates)
