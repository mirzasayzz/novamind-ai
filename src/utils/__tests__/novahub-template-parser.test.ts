/**
 * Tests for Mustache Template Parser (formerly NovaHub Template Parser)
 */

import {
  parseNovaHubTemplate,
  generateFinalSystemPrompt,
} from '../novahub-template-parser';

describe('Mustache Template Parser', () => {
  describe('parseNovaHubTemplate - Mustache Format', () => {
...
You are {{characterName}}, a wise wizard.`;
      ...
      const result = parseNovaHubTemplate(template);
