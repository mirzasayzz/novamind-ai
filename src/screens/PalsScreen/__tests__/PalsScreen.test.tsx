...
import {createPal, createNovaHubPal} from '../../../../jest/fixtures/pals';
...
describe('PalsScreen', () => {
  ...
  describe('Filter Functionality', () => {
    beforeEach(() => {
      ...
      palStore.cachedNovaHubPals = [
        createNovaHubPal({id: 'hub-1', title: 'Free Hub Pal', price_cents: 0}),
        createNovaHubPal({
          id: 'hub-2',
  ...
  describe('Pal Interactions', () => {
    beforeEach(() => {
      ...
      palStore.cachedNovaHubPals = [
        createNovaHubPal({id: 'hub-1', title: 'Hub Test Pal', price_cents: 0}),
      ];
    });
    ...
    it('should open pal detail sheet when NovaHub pal is pressed', async () => {
      const {getByText} = render(<PalsScreen />, {
        withNavigation: true,
        withSafeArea: true,
        withBottomSheetProvider: true,
  ...
  describe('Empty States', () => {
    ...
    it('should show appropriate empty state for local filter', async () => {
      palStore.pals = [];
      palStore.cachedNovaHubPals = [
        createNovaHubPal({id: 'hub-1', title: 'Hub Pal', price_cents: 0}),
      ];
  ...
  describe('Data Loading', () => {
    ...
    it('should render correctly when authenticated', async () => {
      ...
      palStore.userLibrary = [
        createNovaHubPal({id: 'lib-1', title: 'Library Pal', price_cents: 0}),
      ];
