...
**iPhone** users can grab it here: [NovaMind AI on the App Store](https://github.com/mirzasayzz/novamind-ai/releases)

**Android** users can get it from here: [NovaMind AI on Google Play](https://github.com/mirzasayzz/novamind-ai/releases)
...
### Available Models
NovaMind AI comes pre-configured with some popular SLMs:
...
To keep the device running smoothly, NovaMind AI can automatically manage memory usage:
...
**Developers**: NovaMind AI is built using React Native. Finding an easy solution that balances text selection with preserved formatting (especially Markdown support) has been tricky for me. If you have experience in this area, I’d love to hear from you!
