...
NovaMind uses [Weblate](https://github.com/mirzasayzz/novamind-ai) for managing translations. When adding or changing user-facing strings:
...
**To contribute translations**, visit [NovaMind on Weblate](https://github.com/mirzasayzz/novamind-ai) — no code changes needed.
