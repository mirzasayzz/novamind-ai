...
import com.novamind.specs.NativeAuthSessionSpec
...
class AuthSessionModule(reactContext: ReactApplicationContext) :
   ...
   * in-flight promise; any other novamind:// intent (e.g. host=hub) falls
  ...
  private companion object {
    // Host segment of the checkout callback (novamind://checkout/*). Other
    // novamind:// hosts (e.g. hub) are not the checkout return.
